...
<button type="button" onClick="return click_remove_checked('users');" class="btn btn-danger"><i class="fa fa-remove"></i> XÓA <span v-if="allow_mysql_delete == true">Hoàn toàn</span></button> 
</div> 
<div v-if="by_is_deleted != DeletedStatus_DELETED"> 
