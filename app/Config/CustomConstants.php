...
defined('MEMBER_URI') || define('MEMBER_URI', 'admin/posts');

// các keyword để replace content nhanh
define('REPLACE_CONTENT', array(
    '^congty' => "ReplaceCotent/lien-he.php",
    '^sdt' => "ReplaceCotent/sdt.php",
    '^email' => "ReplaceCotent/email.php",
    '^seo' => "ReplaceCotent/seo.php"
));
// website của nhà phát triển
defined('PARTNER_WEBSITE') || define('PARTNER_WEBSITE', 'https://luatanhngoc.vn/');
defined('PARTNER_BRAND_NAME') || define('PARTNER_BRAND_NAME', 'luatanhngoc.vn');
//
